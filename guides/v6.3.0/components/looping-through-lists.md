...
[`{{#each}}`](https://api.emberjs.com/ember/6.3.0/classes/Ember.Templates.helpers/methods/each?anchor=each)
  ...
  <div class="cta-note">
    <div class="cta-note-body">
      ...
      <div class="cta-note-message">
        ...
        <p>
        We can use the <a href="https://api.emberjs.com/ember/6.3.0/functions/@ember%2Ftemplate/htmlSafe">htmlSafe</a>
...
The [`{{#each}}`](https://api.emberjs.com/ember/6.3.0/classes/Ember.Templates.helpers/methods/each?anchor=each)
